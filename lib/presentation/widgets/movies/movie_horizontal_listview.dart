        ...
        children: [
          ...
          SizedBox(
            ...
            child: ClipRRect(
              ...
              // Evento de enrutamiento a la pantalla de detalles de la película
              child: GestureDetector(
                onTap: () => context.push("/home/0/movie/${movie.id}"),
                child: FadeInImage(height: 220, fit: BoxFit.cover, placeholder: const AssetImage("assets/loaders/bottle-loader.gif"), image: NetworkImage(movie.posterPath)),
              ),
            ),
          ),
